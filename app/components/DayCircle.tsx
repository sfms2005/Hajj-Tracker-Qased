...
export default function DayCircle({ stage, isActive }: Props) {
  ...
  const activeStyle =
    "h-[108px] w-[108px] bg-[linear-gradient(135deg,#1f3d2b,#2e6b4a)] text-white shadow-[0_10px_24px_rgba(31,61,43,0.28)] ring-2 ring-[#d1ae37]/70 ring-offset-2 ring-offset-[#f7f5f2]";
  const idleStyle =
